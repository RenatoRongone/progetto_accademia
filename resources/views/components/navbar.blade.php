            ...
            <ul class="navbar-nav ms-auto mb-2 mb-sm-0 me-md-0 linkContainer">
                ...
                <li class="nav-item">
                    <form method="GET" action="{{route('ricerca')}}" class="d-flex" role="search">
                        @csrf
                        <button class="btn p-md-2 p-0" type="button" id="searchBotton">
                            <i class="fa-solid fa-magnifying-glass textMyWhite" id="iconSearch"></i>
                        </button>
                        <input class="form-control me-2 searchInput d-none" type="search" placeholder="Search" aria-label="Search" name='searched' id="searchBar">
                    </form>
                </li>
